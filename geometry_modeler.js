class GeometryModeler {
    ...
    extrudeProfile(h, profile2d, color) {
        var bottomProfile = [];
        var topProfile = [];
        //Mesh array
        var pointsArray = [];
        ...
        if (ThreeDLib.isConvex(topProfile)) {
            ...
            //top face
            this.createTopFace(topProfile, pointsArray, normalsArray, colorsArray, color);
            //bottom face
            this.createBottomFace(bottomProfile, pointsArray, normalsArray, colorsArray, color);
        ...
        return new Mesh([0, 0, 0], pointsArray, colorsArray, normalsArray);
    }
    createTopFace(topProfile, pointsArray, normalsArray, colorsArray, color) {
    ...
    createBottomFace(bottomProfile, pointsArray, normalsArray, colorsArray, color) {
